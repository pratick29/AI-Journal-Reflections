              ...
              <div className="absolute right-0 top-full mt-1.5 z-50 w-64 bg-[#FFFDF9] border border-[#E2DDD5] border-t-2 border-t-[#C4432B] shadow-xl p-1.5 rounded-xs space-y-2 animate-in fade-in zoom-in-95 duration-100 max-h-[85vh] overflow-y-auto">
                  ...
                  {onOpenAnthology && (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span>Export Book / PDF</span>
                      </div>
                      <span className="text-[9px] font-sans uppercase tracking-wider text-[#8A8478]">Export</span>
                    </button>
                  )}
                </div>
                ...
                <div className="space-y-0.5 pt-1 border-t border-[#E2DDD5]/60">
                  ...
                  <button
                    ...
                    className="w-full text-left px-2.5 py-1.5 text-xs font-serif text-[#595652] hover:bg-[#F7F4EE] transition-colors flex items-center justify-between rounded-xs border-t border-[#E2DDD5]/60 pt-1.5"
                  >
                    <div className="flex items-center gap-2">
